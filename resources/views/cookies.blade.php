...
<html data-wf-page="6800d40fd381a0d718546ee4" data-wf-site="67effaf7b7f4ff8926a2a31f" lang="en">
<head>
    <meta charset="utf-8">
    <title>Cookies</title>
        ...
        <div class="w-layout-grid footer-grid">
            ...
            <div class="footer-link-block">
                ...
                <div class="flex-vertical gap-12 margin-top">
                    ...
                    <a href="{{route('cookies')}}" target="_blank" aria-current="page" class="footer-link w--current">Cookies</a>
                </div>
            </div>
            <div class="footer-link-block">
