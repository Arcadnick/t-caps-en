...
<html data-wf-page="67effaf7b7f4ff8926a2a3b4" data-wf-site="67effaf7b7f4ff8926a2a31f" lang="en">
<head>
    <meta charset="utf-8">
...
<section class="fix-block-logo">
    <div class="wrapper-logo-header">
        <a href="{{ route('welcome') }}" class="nav-logo w-nav-brand"><img src="{{ asset('images/logo.svg') }}" loading="lazy" alt="" class="logo"></a>
    </div>
</section>
<section class="hero-section legal-page">
    <div class="container">
        <div class="heading-privacy-block">
            <div class="flex-vertical center-aling">
                <h1>User agreement</h1>
                <div class="subheader">Updated February 12, 2025</div>
            </div>
            <div class="wrapper-button">
                <a href="#scroll-section" class="button-black w-inline-block">
                    <div>Scroll down</div>
                </a>
            </div>
        </div>
        ...
        <div class="w-layout-grid footer-grid">
            ...
            <div class="footer-link-block">
                ...
                <div class="flex-vertical gap-12 margin-top">
                    ...
                    <a href="{{ route('user-agreement') }}" target="_blank" aria-current="page" class="footer-link w--current">User agreement</a>
