...
<html data-wf-page="67effaf7b7f4ff8926a2a3b3" data-wf-site="67effaf7b7f4ff8926a2a31f" lang="en">
<head>
    <meta charset="utf-8">
        ...
        <div class="w-layout-grid footer-grid">
            ...
            <div class="footer-link-block">
                ...
                <div class="flex-vertical gap-12 margin-top">
                    <a href="{{ route('privacy-policy') }}" target="_blank" aria-current="page" class="footer-link w--current">Privacy Policy</a>
